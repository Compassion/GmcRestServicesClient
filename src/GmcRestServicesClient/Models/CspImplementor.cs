...
namespace GmcRestServicesClient.Models
{
    ...
    {
        /// <summary>
        /// Value of the CSP Implementor Id associated with the input parameter
        /// </summary>
        ...
        /// <summary>
        ///  Project activities targeted to cognitive and/or vocational development  
        /// </summary>
        ...
        /// <summary>
        ///  Project activities targeted to physical development  
        /// </summary>
        public string PhysicalOrHealthActivities { get; set; }

        /// <summary>
        ///  Project activities targeted to social/emotional development  
        /// </summary>
        public string SocialOrEmotionalActivities { get; set; }

        /// <summary>
        ///  Project activities targeted to spiritual development  
        /// </summary>
        public string SpiritualActivities { get; set; }

        /// <summary>
        /// Flag indicating if gifts may be disbursed to the CSP Implementor 
        /// </summary>
        public bool DisburseGifts { get; set; }

        /// <summary>
        /// Flag indicating if funds, not including gifts can be disbursed to the CSP Implementor 
        /// </summary>
        public bool DisburseFunds { get; set; }

        /// <summary>
        ///  Flag indicating if unsponsored funds can be disbursed to the CSP Implementor 
        /// </summary>
        ...
        /// <summary>
        /// GPS Latitude of the location of the CSP Implementor – High Precision 
        /// </summary>
