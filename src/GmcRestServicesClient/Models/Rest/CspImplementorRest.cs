...
{
    public class CspImplementorRest
    {
        ...
        public string FirstEnteredDate { get; set; }
        ...
        public string DateStatusDateEntered { get; set; }
        ...
        public string DescriptionModificationDate { get; set; }
